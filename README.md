...
**Important**: This workflow is designed for production use by external CI systems. It expects test images to already exist in the `outputs/` directory and only performs visual comparison. It does not generate test images.
